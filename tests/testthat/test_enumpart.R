...
test_that("enumpart preparation runs correctly", {
    expected = c(6, 23, 3, 23, 3, 6, 21, 23, 3, 21, 1, 6, 1, 3, 3, 4, 4, 21, 1,
                 4, 2, 21, 1, 2, 2, 4, 6, 9, 1, 9, 18, 21, 2, 18, 1, 14, 9, 14,
                 1, 15, 14, 15, 1, 13, 13, 15, 2, 16, 16, 18, 1, 12, 12, 13, 1,
                 11, 11, 12, 1, 10, 10, 11, 2, 17, 16, 17, 1, 8, 8, 10, 1, 7, 7,
                 8, 2, 19, 17, 19, 2, 20, 19, 20, 1, 5, 5, 7, 2, 22, 20, 22, 5,
                 22, 5, 24, 22, 24, 5, 25, 22, 25, 24, 25)
