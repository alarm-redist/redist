test_that('single chain maintains backward compatibility', {
  ...
  result <- redist_bud(fl_map, 300, init_name = FALSE)
...
test_that('multiple chains work with default ncores', {
  ...
  result <- redist_bud(fl_map, 300, chains = 2, init_name = FALSE)
...
test_that('chains with explicit ncores', {
  ...
  result <- redist_bud(fl_map, 300, chains = 2, ncores = 2, init_name = FALSE)
...
test_that('init_plan as single vector replicates across chains', {
  ...
  result <- redist_bud(fl_map, 20, chains = 2, init_plan = init_vec, init_name = 'shared_init')
...
test_that('init_plan as matrix provides one per chain', {
  ...
  result <- redist_bud(fl_map, 20, chains = 2, init_plan = init_mat, init_name = 'chain_init')
...
test_that("init_plan='sample' generates unique inits per chain", {
  ...
  result <- redist_bud(fl_map, 20, chains = 2, init_plan = 'sample', init_name = 'sampled')
...
test_that('return_all=FALSE returns only final plans', {
  ...
  result <- redist_bud(fl_map, 50, chains = 2, return_all = FALSE, init_name = FALSE)
...
test_that('warmup and thin work with chains', {
  ...
  result <- redist_bud(fl_map, 60, chains = 2, warmup = 20, thin = 2, init_name = FALSE)
...
test_that('chains validation rejects invalid values', {
  expect_error(redist_bud(fl_map, 30, chains = 0), 'chains.*must be positive')
  expect_error(redist_bud(fl_map, 30, chains = -1), 'chains.*must be positive')
})
...
test_that('init_plan matrix validation', {
  ...
  expect_error(
    redist_bud(fl_map, 30, chains = 2, init_plan = init_mat),
...
test_that('reference plans added correctly with chains', {
  ...
  result <- redist_bud(fl_map, 20, chains = 2, init_plan = init_vec, init_name = 'myinit')
...
test_that('mh_acceptance calculated per chain', {
  ...
  result <- redist_bud(fl_map, 50, chains = 2)
...
test_that('summary works with single chain', {
  ...
  result <- redist_bud(fl_map, 50, init_name = FALSE)
...
test_that('summary works with multiple chains', {
  ...
  result <- redist_bud(fl_map, 500, chains = 2, init_name = FALSE)
