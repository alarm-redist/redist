...
test_that("redist.mcmc works", {
    ...
    test9 <- redist.mcmc(adjobj = algdat.pfull$adjlist,
                         ...
                         nsims = nsims,
                         nloop = 2,
                         savename = "testsave/test")
    load("testsave/test.RData")
    ...
    test12b <- redist.mcmc(adjobj = algdat.pfull$adjlist,
                           ...
                           nloop = 2,
                           nsims = nsims,
                           savename = "testsave/testmsb")
    load("testsave/testmsa.RData")
    msa <- algout
    load("testsave/testmsb.RData")
    msb <- algout
