...
# Sampling Space
GRAPH_PLAN_SPACE_SAMPLING <- "graph_plan_space"
FOREST_SPACE_SAMPLING <- "spanning_forest_space"

VALID_SAMPLING_SPACES <- c(GRAPH_PLAN_SPACE_SAMPLING, FOREST_SPACE_SAMPLING)
