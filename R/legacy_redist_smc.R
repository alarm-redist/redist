...
#'
#' `legacy_redist_smc` uses a Sequential Monte Carlo algorithm (McCartan and Imai 2023)
...
#' }
#'
#' @return `legacy_redist_smc` returns a [redist_plans] object containing the simulated
#' plans.
#'
#' @references
...
#' sampled_constr <- legacy_redist_smc(fl_map, 5000, constraints = constr)
#'
#' # Multiple parallel independent runs
#' legacy_redist_smc(fl_map, 1000, runs = 2)
#'
#' # One run with multiple cores
#' legacy_redist_smc(fl_map, 1000, num_processes = 2)
#' }
#'
#' @concept simulate
#' @md
#' @order 1
legacy_redist_smc <- function(map, nsims, counties = NULL, compactness = 1, constraints = list(),
