...
#' redistricting plans.
#'
#' @usage redist.samplepart(adjobj, ndists, contiguitymap)
#'
#' @param adjobj An adjacency list, matrix, or object of class
#' \code{SpatialPolygonsDataFrame}.
...
#' @export
redist.samplepart <- function(adjobj, ndists, contiguitymap = "rooks"){
    ...
    ## -------------------------
    enum_out <- sample_partition(adjlist, ndists)
