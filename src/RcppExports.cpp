...
BEGIN_RCPP
    ...
    Rcpp::traits::input_parameter< arma::uvec >::type no_split_precincts(no_split_precinctsSEXP);
    Rcpp::traits::input_parameter< arma::mat >::type borderlength_mat(borderlength_matSEXP);
