...
// mew_plans
Rcpp::List mew_plans(int nsims, List adj, const arma::uvec& init, const arma::uvec& counties, const arma::uvec& pop, int n_distr, double target, double lower, double upper, double rho, List constraints, List control, int thin, int verbosity);
RcppExport SEXP _redist_mew_plans(SEXP nsimsSEXP, SEXP adjSEXP, SEXP initSEXP, SEXP countiesSEXP, SEXP popSEXP, SEXP n_distrSEXP, SEXP targetSEXP, SEXP lowerSEXP, SEXP upperSEXP, SEXP rhoSEXP, SEXP constraintsSEXP, SEXP controlSEXP, SEXP thinSEXP, SEXP verbositySEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    ...
    Rcpp::traits::input_parameter< int >::type thin(thinSEXP);
    Rcpp::traits::input_parameter< int >::type verbosity(verbositySEXP);
    rcpp_result_gen = Rcpp::wrap(mew_plans(nsims, adj, init, counties, pop, n_distr, target, lower, upper, rho, constraints, control, thin, verbosity));
    return rcpp_result_gen;
END_RCPP
}
// pareto_dominated
...
static const R_CallMethodDef CallEntries[] = {
    ...
    {"_redist_mew_plans", (DL_FUNC) &_redist_mew_plans, 14},
