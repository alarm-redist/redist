...
int check_contiguity(Rcpp::List adj_list, Rcpp::IntegerVector p_neighbors, int p_neighbors_size,
                     Rcpp::IntegerVector d_neighbors, int i_dist,
