 ...
 */
// [[Rcpp::export]]
IntegerMatrix smc_plans(int N, List l, const IntegerVector &counties,
 ...
 */
void split_maps(const Graph &g, const IntegerVector &counties, Multigraph &cg,
                const IntegerVector &pop, umat &districts, vec &lp, vec &pop_left,
 ...
 */
double split_map(const Graph &g, const IntegerVector &counties, Multigraph &cg,
...
void adapt_parameters(const Graph &g, int &k, double &prob, int N_adapt, int valid,
                      ...
                      const umat &districts, const IntegerVector &counties,
                      Multigraph &cg, const IntegerVector &pop,
