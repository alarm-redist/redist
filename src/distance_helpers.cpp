...
int closest_adj(IntegerVector adj, int i_dist, NumericVector x, NumericVector y) {
...
// [[Rcpp::export]]
double dist_dist_diff(int p, int i_dist, int j_dist, NumericVector x_center,
                      NumericVector y_center, NumericVector x, NumericVector y) {
