		...
		double ssd_denominator)
{
  ...
  */
  ...
  if(weight_population != 0.0){
    ...
    population_constraint = calc_psipop(cds_prop, cds_test, pop_vec);
  ...
  if(weight_compact != 0.0){
    ...
    compact_constraint = calc_psicompact(cds_prop, cds_test, pop_vec, ssdmat, ssd_denominator);
  ...
  if(weight_segregation != 0.0){
    ...
    segregation_constraint = calc_psisegregation(cds_prop, cds_test, pop_vec, group_pop_vec);
  ...
  if(weight_similar != 0.0){
    ...
    similar_constraint = calc_psisimilar(cds_prop, cds_test, cds_orig);
