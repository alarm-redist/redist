...
-   [Ben Fifield](https://benfifield.com),
...
-   [The Essential Role of Empirical Validation in Legislative Redistricting
    Simulation](https://doi.org/10.1080/2330443X.2020.1791773) *Statistics and
    Public Policy* Vol. 7, No. 1, pp. 52-68.
...
You can also install the most recent development version of `redist` using the
\`remotes\`\` package.
...
In some cases, there are two functions with the same purpose that operate on
different inputs. For most users, we recommend working with the versions that
operate on `redist_map` and `redist_plan` objects.
