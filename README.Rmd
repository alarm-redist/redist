...
After generating plans, you can use `gredist`'s plotting functions to study the
...
found in the [Get Started](https://alarm-gredist.org/gredist/articles/gredist.html) 
page. The package [vignettes](https://alarm-gredist.org/gredist/articles/) 
